...
function init() {
    ...
    var planeMeterial = new THREE.MeshBasicMaterial({ color: 0xAAAAAA });
    ...
    var cubeMetarial = new THREE.MeshBasicMaterial({
        color: 0xFF0000,
        wireframe: true
    });
    ...
    var sphereMetarial = new THREE.MeshBasicMaterial({
        color: 0x7777FF,
        wireframe: true
    });
